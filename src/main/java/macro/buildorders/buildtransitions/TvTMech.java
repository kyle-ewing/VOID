...
public class TvTMech extends BuildTransition {
    public BuildTransitionName getBuildTransitionName() {
        return BuildTransitionName.TVTMECH;
    }

    public ArrayList<PlannedItem> getTransitionBuild() {
        ArrayList<PlannedItem> transitionItems = new ArrayList<>();
        transitionItems.add(new PlannedItem(UnitType.Terran_Armory, PlannedItemStatus.NOT_STARTED, PlannedItemType.ADDON, 4));
        transitionItems.add(new PlannedItem(UpgradeType.Terran_Vehicle_Weapons, PlannedItemStatus.NOT_STARTED, PlannedItemType.UPGRADE, UnitType.Terran_Engineering_Bay, 2, 4));
        transitionItems.add(new PlannedItem(UpgradeType.Terran_Vehicle_Plating, PlannedItemStatus.NOT_STARTED, PlannedItemType.UPGRADE, UnitType.Terran_Engineering_Bay, 2, 5));
        transitionItems.add(new PlannedItem(UpgradeType.Terran_Vehicle_Weapons, PlannedItemStatus.NOT_STARTED, PlannedItemType.UPGRADE, UnitType.Terran_Engineering_Bay, 3, 4));
        transitionItems.add(new PlannedItem(UpgradeType.Terran_Vehicle_Plating, PlannedItemStatus.NOT_STARTED, PlannedItemType.UPGRADE, UnitType.Terran_Engineering_Bay, 3, 5));
        ...
        transitionItems.add(new PlannedItem(UnitType.Terran_Factory, PlannedItemStatus.NOT_STARTED, PlannedItemType.BUILDING, 6));
        transitionItems.add(new PlannedItem(UnitType.Terran_Factory, PlannedItemStatus.NOT_STARTED, PlannedItemType.BUILDING, 6));

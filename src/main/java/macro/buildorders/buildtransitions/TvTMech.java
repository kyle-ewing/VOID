...
public class TvTMech extends BuildTransition {
    ...
    public ArrayList<PlannedItem> getTransitionBuild() {
        ...
        transitionItems.add(new PlannedItem(UnitType.Terran_Armory, PlannedItemType.BUILDING, 6));
    ...
    public ArrayList<PlannedItem> getOptionalBuildings() {
        ...
        optionalItems.add(new PlannedItem(UnitType.Terran_Physics_Lab, PlannedItemType.ADDON, 6));

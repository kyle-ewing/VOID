...
public class GoliathFE extends BuildOrder {
    ...
    public ArrayList<PlannedItem> getBuildOrder() {
        ...
        buildOrder.add(new PlannedItem(UnitType.Terran_Factory, 17, PlannedItemStatus.NOT_STARTED, PlannedItemType.BUILDING, 1, true));
        ...
        buildOrder.add(new PlannedItem(UnitType.Terran_Factory, 29, PlannedItemStatus.NOT_STARTED, PlannedItemType.BUILDING, 2, true));

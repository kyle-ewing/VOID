...
public class TwoRaxAcademy extends BuildOrder {
    ...
    public ArrayList<PlannedItem> getBuildOrder() {
        ...
        buildOrder.add(new PlannedItem(UnitType.Terran_Missile_Turret, 27, PlannedItemStatus.NOT_STARTED, PlannedItemType.BUILDING, 2));
        ...
        buildOrder.add(new PlannedItem(UnitType.Terran_Factory, 40, PlannedItemStatus.NOT_STARTED, PlannedItemType.BUILDING, 2));
        buildOrder.add(new PlannedItem(UnitType.Terran_Machine_Shop, 40, PlannedItemStatus.NOT_STARTED, PlannedItemType.ADDON, 2));
        buildOrder.add(new PlannedItem(TechType.Tank_Siege_Mode, 40, PlannedItemStatus.NOT_STARTED, PlannedItemType.UPGRADE, UnitType.Terran_Machine_Shop, 2));

...
public class TwoRaxAcademy extends BuildOrder {
    ...
    public ArrayList<PlannedItem> getBuildOrder() {
        ...
        buildOrder.add(new PlannedItem(UnitType.Terran_Refinery, 19, PlannedItemStatus.NOT_STARTED, PlannedItemType.BUILDING, 1));
        ...
        buildOrder.add(new PlannedItem(UnitType.Terran_Factory, 34, PlannedItemStatus.NOT_STARTED, PlannedItemType.BUILDING, 1, true));
        ...
        buildOrder.add(new PlannedItem(UnitType.Terran_Command_Center,  40, PlannedItemStatus.NOT_STARTED, PlannedItemType.BUILDING, 1));
        return buildOrder;
    }

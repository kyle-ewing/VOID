...
public class FactoryExpand extends MechBuildOrder {
    ...
    public ArrayList<PlannedItem> getBuildOrder() {
        ...
        buildOrder.add(new PlannedItem(UnitType.Terran_Marine, 18, PlannedItemType.UNIT, 3));
        buildOrder.add(new PlannedItem(UnitType.Terran_Marine, 21, PlannedItemType.UNIT, 3));
        ...
        buildOrder.add(new PlannedItem(UnitType.Terran_Starport, 38, PlannedItemType.BUILDING, 1, true));
        ...
        buildOrder.add(new PlannedItem(UnitType.Terran_Armory, 36, PlannedItemType.BUILDING, 1));
        ...
        buildOrder.add(new PlannedItem(UnitType.Terran_Science_Facility, 50, PlannedItemType.BUILDING, 2));

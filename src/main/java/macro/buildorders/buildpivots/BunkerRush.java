...
public class BunkerRush extends BuildPivot {
    ...
    public ArrayList<PlannedItem> getPivotBuild() {
        ...
        buildOrder.add(new PlannedItem(UnitType.Terran_Barracks, 23, PlannedItemType.BUILDING, 1));
        ...
        buildOrder.add(new PlannedItem(UnitType.Terran_Command_Center, 50, PlannedItemType.BUILDING, 3));

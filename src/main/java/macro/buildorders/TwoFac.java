...
public class TwoFac implements BuildOrder {
    ...
    public ArrayList<PlannedItem> getBuildOrder() {
        ...
        buildOrder.add(new PlannedItem(UnitType.Terran_Bunker, 22, PlannedItemStatus.NOT_STARTED, PlannedItemType.BUILDING, 2));
        ...
        buildOrder.add(new PlannedItem(UnitType.Terran_Command_Center, 32, PlannedItemStatus.NOT_STARTED, PlannedItemType.BUILDING, 1));
        buildOrder.add(new PlannedItem(TechType.Tank_Siege_Mode, 34, PlannedItemStatus.NOT_STARTED, PlannedItemType.UPGRADE, UnitType.Terran_Machine_Shop, 2));

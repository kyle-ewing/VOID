package macro.buildorders.terran;
...
public class GoliathFE extends MechBuildOrder {
    ...
    public ArrayList<PlannedItem> getBuildOrder() {
        ...
        buildOrder.add(new PlannedItem(UnitType.Terran_Marine,18, PlannedItemType.UNIT, 2));
        buildOrder.add(new PlannedItem(UnitType.Terran_Bunker, 17, PlannedItemType.BUILDING, 2));
        buildOrder.add(new PlannedItem(UnitType.Terran_Vulture,22, PlannedItemType.UNIT, 2));
        ...
        buildOrder.add(new PlannedItem(UnitType.Terran_Engineering_Bay, 25, PlannedItemType.BUILDING, 2));
        buildOrder.add(new PlannedItem(UnitType.Terran_Machine_Shop, 25, PlannedItemType.ADDON, 3));
        buildOrder.add(new PlannedItem(UnitType.Terran_Armory, 27, PlannedItemType.BUILDING, 2));
        buildOrder.add(new PlannedItem(UnitType.Terran_Factory, 29, PlannedItemType.BUILDING, 2, true));
        buildOrder.add(new PlannedItem(UnitType.Terran_Supply_Depot, 36, PlannedItemType.BUILDING, 2));
        buildOrder.add(new PlannedItem(UnitType.Terran_Machine_Shop, 32, PlannedItemType.ADDON, 2));
        buildOrder.add(new PlannedItem(UnitType.Terran_Academy, 42, PlannedItemType.BUILDING, 2));
        buildOrder.add(new PlannedItem(UnitType.Terran_Supply_Depot, 44, PlannedItemType.BUILDING, 2));
        buildOrder.add(new PlannedItem(UnitType.Terran_Refinery, 52, PlannedItemType.BUILDING, 2));
        buildOrder.add(new PlannedItem(TechType.Tank_Siege_Mode, 29, PlannedItemType.UPGRADE, UnitType.Terran_Machine_Shop, 3));
        buildOrder.add(new PlannedItem(UpgradeType.Charon_Boosters, 60, PlannedItemType.UPGRADE, UnitType.Terran_Factory, 1, 3));
        buildOrder.add(new PlannedItem(UpgradeType.Terran_Vehicle_Weapons, 46, PlannedItemType.UPGRADE, UnitType.Terran_Armory, 1, 3));
        buildOrder.add(new PlannedItem(UpgradeType.Terran_Vehicle_Plating, 46, PlannedItemType.UPGRADE, UnitType.Terran_Armory, 1, 6));
        // buildOrder.add(new PlannedItem(TechType.Spider_Mines, 44, PlannedItemType.UPGRADE, UnitType.Terran_Machine_Shop, 4));
        // buildOrder.add(new PlannedItem(UpgradeType.Ion_Thrusters, 44, PlannedItemType.UPGRADE, UnitType.Terran_Machine_Shop, 1,5));
        return buildOrder;
    }

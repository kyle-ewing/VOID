...
public class OneFacFE extends MechBuildOrder {
    ...
    public ArrayList<PlannedItem> getBuildOrder() {
        ...
        buildOrder.add(new PlannedItem(UnitType.Terran_Marine, 17, PlannedItemType.UNIT, 2));
        ...
        buildOrder.add(new PlannedItem(TechType.Spider_Mines, 29, PlannedItemType.UPGRADE, UnitType.Terran_Machine_Shop, 1));
        ...
        buildOrder.add(new PlannedItem(UnitType.Terran_Vulture, 30, PlannedItemType.UNIT, 3));
        ...
        buildOrder.add(new PlannedItem(UnitType.Terran_Academy, 48, PlannedItemType.BUILDING, 2));
